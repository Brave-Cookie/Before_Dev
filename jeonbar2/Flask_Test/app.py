...
@app.route('/summarize')
def sum():
    s1='수지야 우리 프로젝트있잖아 망했어\n'    
    s2='왜 망했어 혹시 뷰로 하던게 문제가 생긴거야?\n'    
    s3='우리가 뷰로 하던게 호환이 안되서 망한거같아.\n'    
    s4='헐 그럼 어떻게 할거야?\n'    
    s5='프로젝트에서 뷰를 버릴까?\n'    
    s6='뷰를 버리고해도되겠다\n'    
    s7='리액트를 쓰자\n'    
    s8='그래 리액트는 그래도 빨리 해볼수 있겠지?\n'    
    s9='리액트는 우리가 하던게 있어서 빨리할수있어.\n'    
    s10='그럼 우리 프로젝트는 리액트로 다시 열심히 해보자\n'    
